...
<div style="margin-top: 0px; padding-top: 0px;" class="box box-success">
    <div class="box-header">
        <h3 class="box-title"><i class="fa fa-dashboard"></i>&nbsp;&nbsp;<b>ADMIN DASHBOARD</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<small>System Overview</small> <span><b>(<?php echo mdate('%d/%m/%Y %H:%i:%s');?>)</b></span></h3>
    </div>
    <div class="box-body">
              ...
              <div class="rov" style="padding: 0 0 0 0;">
                  <div class="col-md-6 " style="padding: 0 5px 0 0;">
                      <div class="well well-sm">
                          <b style="font-size: 20px;">OUTAGES</b>
                          <div class="row" >
                            ...
                            <div class="col-lg-6 col-sm-12">
                                <div class="circle-tile">
                                    <a href="<?php echo base_url('Outage')?>">
                                    <!-- <a href="<?php //echo base_url('Luku/updateClosure')?>"> -->
                                        <div class="circle-tile-heading blue">
                                            <i class="fa fa-tasks fa-fw fa-3x"></i>
                                        </div>
                                    </a>
                              ...
                              <div class="col-lg-6 col-sm-12">
                                <div class="circle-tile">
                                    <a href="<?php echo base_url('#')?>">
                                        <div class="circle-tile-heading yellow">
                                            <i class="fa  fa-folder-open-o fa-fw fa-3x"></i>
                                        </div>
                                    </a>
                                    <div class="circle-tile-content blue">
                                        <div class="circle-tile-description text-faded">
