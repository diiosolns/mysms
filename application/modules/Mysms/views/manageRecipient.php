    ...
    /*=============end pagnation ===*/
                                ...
                                <div class="box box-info middle_pad " style="margin-top: 0px;">
                                                <div class="box-header">
                                                    <h3 class="box-title"><b><?php //echo $this->lang->line('msg_manage_tmonial'); ?> Manage SMS Recipients</b></h3>
                                                </div><!-- /.box-header -->
                                                <div class="col-md-12" style="text-align: center;">
                                                    <b style="color: <?php echo $color;?>;"><?php echo $msg;?></b>
                                                </div>
                                                <div class="box-body padding"  style="overflow-x:scroll; white-space: nowrap;">
                                                <form action="<?php echo base_url('Mysms/manageRecipient')?>" method="post">
                                                    <table class="table table-striped">
                                                        ...
                                                        <?php $index = 1;?>
                                                         <?php foreach ($recipientRes->result() as $row): ?>
                                                                <tr>
