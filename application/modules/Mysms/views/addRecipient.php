                    ...
                    <!-- ================== excel uploader ======================= -->
                        <div class="box box-info middle_pad " style="margin-top: 15px;">
                                ...
                                <form action="<?php echo base_url('Mysms/recipientsUp')?>"  method="post" enctype="multipart/form-data">
                                    <div class="box-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <button type="submit" name="downBtn" value="ok" class="btn btn-default btn-md sitein"><b>Dowload Sample&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-file"></i></b></button>
                                            </div>
                                            <div class="col-md-12" style="text-align: center;">
                                                <b style="color: <?php echo $color;?>;"><?php echo $msg;?></b>
                                            </div>
                                    ...
                                    <div class="box-footer" style="text-align: center;">
                                        <button type="submit" name="uploadBtn" value="ok" class="btn btn-info btn-md sitein"><b><?php echo $this->lang->line('msg_save_tmonial'); ?>&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa fa-save"></i></b></button>
                                    </div>
                                </form>
                            </div>
                        <!-- ================== excel uploader ======================== -->