                        ...
                        <li class="dropdown user user-menu">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="user-body">
                                    ...
                                    <div class="col-xs-4 text-center">
                                        <a href="<?php echo base_url('Mysms/manageRecipient')?>">Recipients</a>
                                    </div>
                                    <div class="col-xs-4 text-center">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="<?php echo base_url('Mysms')?>"><i class="fa fa-angle-double-right"></i> Manage SMS logs</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="<?php echo base_url('Mysms/manageRecipient')?>"><i class="fa fa-angle-double-right"></i> Manage Recipients</a></li>
                            </ul>
                        </li>
                       <li class="treeview">
                            <a href="#">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li><a href="<?php echo base_url('Mysms/smsOffers')?>"><i class="fa fa-angle-double-right"></i> Manage Offers</a></li>
                                <li><a href="<?php echo base_url('Mysms')?>"><i class="fa fa-angle-double-right"></i> Manage Invoices</a></li>
                                <li><a href="<?php echo base_url('Mysms/manageCodes')?>"><i class="fa fa-angle-double-right"></i> Manage Codes</a></li>
                            </ul>
                        </li>
                       <li class="treeview">
                            <a href="#">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="<?php echo base_url('Mysms/manageUsers')?>"><i class="fa fa-angle-double-right"></i> Manage Sys Users</a></li>
