<style type="text/css">
    ...
    <?php 
        $grpRes = modules::load('Mysms')->get_col_where('sms_recipient', 'groupname');
                                            ...
                                            <!-- <div class="col-md-4">
                                             ...
                                             <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="sms" rows="6" class="form-control sitein" id="date" placeholder="Write an SMS here !" required="" ><?php echo $smsRes->row()->sms; ?></textarea>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
