                                    ...
                                    <div style="padding-top: 0 20px 0 20px; margin-left: 10px;" class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 200px;"><ul class="menu" style="overflow: hidden; width: 100%; height: 200px;">
                                        <li>
                                            <a href="<?php echo base_url('#')?>">
                                                <i class="fa fa-warning danger"></i>  <?php echo $this->session->userdata('storeNum');?> Incomming 
                                            </a>
                                        </li>
                                        <li>
                                            <a href="<?php echo base_url('#')?>">
                                                <i class="fa fa-warning danger"></i> <?php echo $this->session->userdata('pendingExp');?> Pending 
                                            </a>
                                        </li>
                                        <li>
                                            <a href="<?php echo base_url('#')?>">
                                                <i class="fa fa-wrench warning"></i> <?php echo $this->session->userdata('pendingInc');?> Pending 
                                            </a>
                                        </li>
                                        <li>
                                            <a href="<?php echo base_url('#')?>">
                                                <i class="fa fa-tasks info"></i> <?php echo $this->session->userdata('pendingProd');?> Ongoing 
                                            </a>
                                        </li>
                                        <li>
                                            <a href="<?php echo base_url('#')?>">
                                                <i class="fa fa-tasks warning"></i> <?php echo $this->session->userdata('pendingOrders');?> Open 
                                            </a>
                                        </li>
                                        <li>
                                            <a href="<?php echo base_url('#')?>">
                                                <i class="ion ion-bag success"></i> Tshs. <?php echo $this->session->userdata('salesAmount');?>/= Approved 
                                            </a>
                                        </li>
                                        <li>
                                            <a href="<?php echo base_url('#')?>">
                                                <i class="ion ion-bag success"></i> <?php echo $this->session->userdata('productNum');?> Incomming 
                                            </a>
                                        </li>
                                ...
                                <?php $profileurl = "assets/img/users/".$this->session->userdata('user_img');?>
                                   <img src="<?php echo base_url($profileurl);?>" class="img-circle" alt="user image"/>
                                    <p>
                                        ...
                                        <small>Member DNET</small>
                                    </p>
                                </li>
                                <!-- Menu Body -->
                                <li class="user-body">
                                    <div class="col-xs-4 text-center">
                                        <a href="<?php echo base_url('Prm')?>">PrM</a>
                                    </div>
                                    <div class="col-xs-4 text-center">
                                        <a href="<?php echo base_url('Noc')?>">NOC</a>
                                    </div>
                                    <div class="col-xs-4 text-center">
                                        <a href="<?php echo base_url('Slm')?>">SLM</a>
                                    </div>
                                </li>
                                <!-- Menu Footer-->
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="<?php echo base_url('Outage/newOutage')?>"><i class="fa fa-angle-double-right"></i> New Outage</a></li>
                                <li><a href="<?php echo base_url('Outage/closeOutage')?>"><i class="fa fa-angle-double-right"></i> Close Outages</a></li>
                                <li><a href="<?php echo base_url('Outage/filteredOutage')?>"><i class="fa fa-angle-double-right"></i> Preview Outages</a></li>
                                <li role="separator" class="divider"></li>
                                <li><a href="<?php echo base_url('Outage/outageReports')?>"><i class="fa fa-angle-double-right"></i>Outage Reports</a></li>
                            </ul>
                        </li>
                        <li class="treeview">
                            <a href="#">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="<?php echo base_url('Kedb/')?>"><i class="fa fa-angle-double-right"></i> Record Known Error</a></li>
                                <li role="separator" class="divider"></li>
                                <li><a href="<?php echo base_url('Kedb/');?>"><i class="fa fa-angle-double-right"></i> Known Error Search</a></li>
                                <li><a href="<?php echo base_url('Kedb/')?>"><i class="fa fa-angle-double-right"></i> KE Reports</a></li>
                            </ul>
                        </li>
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                          <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown">
                             ...
                             <li class="dropdown">
                              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">OUTAGE <span class="caret"></span></a>
                              <ul class="dropdown-menu">
                                <li role="separator" class="divider"></li>
                                <li><a href="<?php echo base_url('Outage/newOutage')?>"><i class="fa fa-angle-double-right"></i> New Outage</a></li>
                                <li><a href="<?php echo base_url('Outage/closeOutage')?>"><i class="fa fa-angle-double-right"></i> Close Outages</a></li>
                            ...
                            <li class="dropdown">
                              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">KEDB <span class="caret"></span></a>
                              <ul class="dropdown-menu">
                                <li role="separator" class="divider"></li>
                                <li><a href="<?php echo base_url('Kedb/')?>"><i class="fa fa-angle-double-right"></i> Record Known Error</a></li>
                                <li><a href="<?php echo base_url('Kedb/');?>"><i class="fa fa-angle-double-right"></i> Known Error Search</a></li>
