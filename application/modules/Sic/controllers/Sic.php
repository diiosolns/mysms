...
class Sic extends MX_Controller
{
...
$query = $this->Mdl_sic->get($order_by);
return $query;
}

function get_with_limit($limit, $offset, $order_by) {
$this->load->model('Mdl_sic');
$query = $this->Mdl_sic->get_with_limit($limit, $offset, $order_by);
return $query;
}

function get_where($id) {
$this->load->model('Mdl_sic');
$query = $this->Mdl_sic->get_where($id);
return $query;
}

function get_where_email($email) {
$this->load->model('Mdl_sic');
$query = $this->Mdl_sic->get_where_email($email);
return $query;
}
function get_all($tb) {
$this->load->model('Mdl_sic');
$query = $this->Mdl_sic->get_all($tb);
return $query;
}
...
$this->load->model('Mdl_sic');
$query = $this->Mdl_sic->get_col_where($tb, $col);
return $query;
}
...
$this->load->model('Mdl_sic');
$query = $this->Mdl_sic->get_where_custom($col, $value);
return $query;
}

function get_where_custom1($tb, $col1, $value1) {
$this->load->model('Mdl_sic');
$query = $this->Mdl_sic->get_where_custom1($tb, $col1, $value1);
return $query;
}

function get_where_custom2($tb, $col1, $value1, $col2, $value2) {
$this->load->model('Mdl_sic');
$query = $this->Mdl_sic->get_where_custom2($tb, $col1, $value1, $col2, $value2);
return $query;
}

function get_where_custom3($tb, $col1, $value1, $col2, $value2, $col3, $value3) {
$this->load->model('Mdl_sic');
$query = $this->Mdl_sic->get_where_custom3($tb, $col1, $value1, $col2, $value2, $col3, $value3) ;
return $query;
}

function get_where_custom4($tb, $col1, $value1, $col2, $value2, $col3, $value3, $col4, $value4) {
$this->load->model('Mdl_sic');
$query = $this->Mdl_sic->get_where_custom4($tb, $col1, $value1, $col2, $value2, $col3, $value3, $col4, $value4) ;
return $query;
}
...
$this->load->model('Mdl_sic');
$this->Mdl_sic->_insert($data);
}

function _update($id, $data) {
$this->load->model('Mdl_sic');
$this->Mdl_sic->_update($id, $data);
}

function _update2($tb, $col, $value, $data) {
$this->load->model('Mdl_sic');
$this->Mdl_sic->_update2($tb, $col, $value, $data);
}

function _delete($id) {
$this->load->model('Mdl_sic');
$this->Mdl_sic->_delete($id);
}

function count_where($column, $value) {
$this->load->model('Mdl_sic');
$count = $this->Mdl_sic->count_where($column, $value);
return $count;
}

function get_max() {
$this->load->model('Mdl_sic');
$max_id = $this->Mdl_sic->get_max();
return $max_id;
}

function _custom_query($mysql_query) {
$this->load->model('Mdl_sic');
$query = $this->Mdl_sic->_custom_query($mysql_query);
return $query;
}
...
$this->load->model('Mdl_sic');
$query = $this->Mdl_sic->getcode($order_by);
return $query;
}

function getcode_where($col,$code) {
$this->load->model('Mdl_sic');
$query = $this->Mdl_sic->getcode_where($col,$code);
return $query;
}

function getcode_wherenot($col,$code) {
$this->load->model('Mdl_sic');
$query = $this->Mdl_sic->getcode_wherenot($col,$code);
return $query;
}

function _insertcode($data) {
$this->load->model('Mdl_sic');
$this->Mdl_sic->_insertcode($data);
}

function _updatecode($col,$code, $data){
$this->load->model('Mdl_sic');
$this->Mdl_sic->_updatecode($col,$code, $data);
}
...
$this->load->model('Mdl_sic');
$query = $this->Mdl_sic->get_tb($tb, $order_by);
return $query;
}

function _insert_tb($tb,$data) {
$this->load->model('Mdl_sic');
$this->Mdl_sic->_insert_tb($tb,$data);
}

function _update_tb($tb, $id, $data) {
$this->load->model('Mdl_sic');
$this->Mdl_sic->_update_tb($tb,$id, $data);
}   

function _delete_tb($tb, $id) {
$this->load->model('Mdl_sic');
$this->Mdl_sic->_delete_tb($tb, $id);
}

function get_where_tb($tb, $id) {
$this->load->model('Mdl_sic');
$query = $this->Mdl_sic->get_where_tb($tb, $id);
return $query;
}

function get_where_custom_tb($tb, $col, $value) {
$this->load->model('Mdl_sic');
$query = $this->Mdl_sic->get_where_custom_tb($tb, $col, $value);
return $query;
}

function count_all_tb($tb) {
$this->load->model('Mdl_sic');
$query = $this->Mdl_sic->count_all_tb($tb);
return $query;
}
